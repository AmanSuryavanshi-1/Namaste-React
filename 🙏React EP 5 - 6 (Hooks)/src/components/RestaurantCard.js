...
const RestaurantCard = (props) => {
  ...
  //      -> To avoid this error, you should ensure that resData and resData.data are always defined before trying to destructure them.
  //      -> You can use optional chaining (?.) to handle this situation gracefully.
