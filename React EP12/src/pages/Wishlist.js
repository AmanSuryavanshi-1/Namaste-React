...
const WishlistComingSoon = () => {
  return (
<div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-primary-bgColor text-primary-white">
      ...
      <div className="relative z-10 max-w-2xl p-10 mx-auto text-center transform -translate-y-12 border shadow-xl rounded-xl bg-primary-grey/30 backdrop-blur-md border-primary-white/10">
        ...
        <p className="mb-8 font-sans text-xl leading-relaxed text-primary-light">
          We're crafting a new wishlist feature that will provide personalized recommendations based on your cart items. Get ready for a smarter food ordering experience!
        </p>
...
export default WishlistComingSoon;
